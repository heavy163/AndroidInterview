...
10 年 Android 应用开发经验，具备从 0 到 1 的架构设计能力及千万DAU项目开发维护能力。善于将 AI 能力嵌入传统业务流程，实现智能化升级。日常使用 Hermes Agent 编排研发任务、Lingma in Android Studio 辅助编码与诊断，形成"架构→编码→诊断→文档"的 AI 提效闭环。曾管理 11 人团队，兼具技术深度与项目领导力。
...
- **AI 时代的实践者**：不满足于"用 AI 工具"，而是深入研究Agent 架构（Tool Calling / Skill 编排 / 异步调度），并将 AI 能力融入日常研发流程中。
